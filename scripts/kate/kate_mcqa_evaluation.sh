...
torchrun --nproc_per_node=${N_GPU} \
         --master_port $MASTER_PORT \
          "${BASE_PATH}/evaluate_mcqa_flexible_icl.py" \
            ...
            --knn_data_file "fake_index.csv" \
            --corpus_filename "jmedbench.json"
...
# bash scripts/evaluation/standard_mcqa_evaluation.sh 8 meta-llama/Llama-2-7b-hf igakuqa,jmmlu_medical,medmcqa_jp,usmleqa_jp,medqa_jp,mmlu_medical_jp mcqa_with_options 4 0 42 -1 False 2333
